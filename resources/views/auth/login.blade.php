...
@section('content')
    <div class="flex items-center justify-center min-h-screen">
        <div class="w-full max-w-md p-8 space-y-6 bg-white rounded-lg shadow-md border border-gray-300 dark:bg-gray-800">
            <h1 class="text-2xl font-bold text-center">Login Sistem Kasir</h1>
            ...
            <form method="POST" action="/login" class="space-y-6">
                @csrf <div>
                    ...
                    <input type="text" name="username" id="username" required autofocus
                        class="w-full px-3 py-2 mt-1 border border-gray-700 rounded-md dark:bg-gray-700 dark:border-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500"
                        value="{{ old('username') }}">
                    @error('username')
